  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl rounded-3xl border border-sky-200 bg-gradient-to-r from-sky-50 to-indigo-50 p-8 shadow-xl sm:p-10">
        ...
        <h2 className="mt-3 text-3xl font-semibold text-slate-950 sm:text-4xl">Comece com um diagnóstico gratuito da sua ideia</h2>
        <p className="mt-4 max-w-4xl text-slate-700">
          Você não precisa chegar com tudo definido. Envie sua ideia, processo ou desafio, e avaliamos juntos o melhor caminho: MVP, SaaS, automação, agente de IA ou aplicação web.
        </p>
